...
#define SD_CS_DISABLE()     GPIO_SetBits(GPIOC,GPIO_Pin_9) 
#define F_CS_DISABLE()      GPIO_SetBits(GPIOC,GPIO_Pin_7)
#define TP_CS_DISABLE()     GPIO_SetBits(GPIOC,GPIO_Pin_8)//不选中SD卡
#define SD_PWR_ON()         								  //SD卡上电
#define SD_PWR_OFF()        								  //SD卡断电
#define SD_DET()           									  //检测有卡
                                                                    //1-有 0-无
